...
contains
  ...
  subroutine read_nk_tables(n_dust, sp, n_wl, wl)
    ...
    do n = 1, n_dust
      ...
      case('Tholin_CG22_0.625')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin_CG22_0.625[s].dat'
      case('Tholin_CG22_1.0')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin_CG22_1.0[s].dat' 
      case('Tholin_CG22_inf')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin_CG22_inf[s].dat'
      case('Tholin_He22')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin_He22[s].dat'
      case('Tholin_He23_300')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin_He23_300[s].dat'
      case('Tholin_He23_400')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin_He23_400[s].dat'
      case('Tholin')
        nk(n)%name = sp(n)
        nk(n)%fname = 'Tholin[s].dat'
      end select
...
end module mini_haze_opac_mie_mod